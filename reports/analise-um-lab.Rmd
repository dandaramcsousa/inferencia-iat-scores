...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemática **negativa** e **forte** (média 0.623, desv. padrão 0.4317694, N = 24). Homens tiveram uma associação **negativa** com a matemática, portanto **menor** que a das mulheres (média 0.0992, desv. padrão 0.5218736, N = 57). Houve portanto uma **considerável** diferença entre homens e mulheres (diferença das médias -0.5241867, 95% CI [-0.7526101, -0.2919278]). A partir desta amostra, estimamos que mulheres têm uma associação negativa mais forte, com uma diferença próximo a 0.5 ponto na escala IAT, o suficiente para diferenciar uma associação neutra de uma muito forte contra a matemática.
